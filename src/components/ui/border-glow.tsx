...
interface BorderGlowProps {
  ...
  colors?: string[]
  fillOpacity?: number
  // Nueva prop para modo claro/oscuro
...
export function BorderGlow({
  ...
  // Usar preset o props personalizadas
  const config = VARIANT_CONFIG[variant]
  const colors = colorsProp || config.colors
  const glowColor = glowColorProp || config.glowColor
  const backgroundColor = backgroundColorProp || config.backgroundColor
